...
<body class="bg-[#f5f5f5]">
    ...
    <div class="modal hidden w-screen h-screen fixed top-0 left-0 bg-slate-900/10 items-center justify-center z-20">
        <div class="bg-white w-[600px] max-w-full h-fit p-12 rounded-lg">
            ...
            <form method="POST" action="#" class="flex flex-col gap-8 w-full">
                <input type="text" placeholder="name" name="name" id="Iname" class="border border-gray-200 rounded outline-none py-2 px-4" />
                <div class="flex justify-between gap-4">
                    <input type="text" placeholder="total price" name="totalPrice" id="ItotalPrice" class="border border-gray-200 rounded outline-none py-2 px-4"/>
                <input type="text" placeholder="discount" name="discount" id="Idiscount" class="border border-gray-200 rounded outline-none py-2 px-4"/>
                </div>
                <input type="text" placeholder="days" name="days" id="Idays" class="border border-gray-200 rounded outline-none py-2 px-4"/>
                <input type="text" placeholder="devices" name="devices" id="devices" class="border border-gray-200 rounded outline-none py-2 px-4"/>
                <button name="create" type="submit" id="btnSubmit" class="bg-purple-800 py-2 text-white rounded">Save</button>
            </form>
        </div>
    </div>
    <script>
